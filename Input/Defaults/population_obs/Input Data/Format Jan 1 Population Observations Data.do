/*******************************************************************************
UN Population By Age Projections - Historical Data
...
local homedir = "C:\Users\Duncan\OneDrive\World Bank\Generic\Input\Defaults\population_obs\Input data"
local outdir = "C:\Users\Duncan\OneDrive\World Bank\Generic\Input\Defaults\population_obs"
cd "`homedir'"

// /* ONLY NEED TO RUN ONCE

** 0. IMPORT AND CLEAN POPULATION DATA 
import delimited "WPP2024_Population1JanuaryBySingleAgeSex_Medium_1950-2023.csv", clear 
drop if iso3_code == ""
...
* Save as temp file
compress
save population_historical_data_jan1.dta, replace
...
* Save the file
compress
save cleaned_pop_historical_data_jan1.dta, replace
...
foreach cnt of local countries {
	preserve
		keep if iso3 == "`cnt'"
		save "population_historical_`cnt'.dta", replace
		*export delimited "population_historical_`cnt'.csv", replace
	restore
	} // end foreach yr
